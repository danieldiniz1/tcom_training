...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tcomstorefront/electronics/en",
						"https://electronics.local:9002/tcomstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tcomstorefront/electronics/en",
						"https://electronics.local:9002/tcomstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tcomstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/tcomstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tcomstorefront/electronics/en",
						"https://electronics.local:9002/tcomstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tcomstorefront",
						"https://electronics.local:9002/tcomstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tcomstorefront",
						"https://electronics.local:9002/tcomstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/tcomstorefront/electronics/en",
						"https://electronics.local:9002/tcomstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
