...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tcomb2bstorefront/electronics/en",
						"https://electronics.local:9002/tcomb2bstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tcomb2bstorefront/electronics/en",
						"https://electronics.local:9002/tcomb2bstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tcomb2bstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/tcomb2bstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tcomb2bstorefront/electronics/en",
						"https://electronics.local:9002/tcomb2bstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tcomb2bstorefront",
						"https://electronics.local:9002/tcomb2bstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tcomb2bstorefront",
						"https://electronics.local:9002/tcomb2bstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/tcomb2bstorefront/electronics/en",
						"https://electronics.local:9002/tcomb2bstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
