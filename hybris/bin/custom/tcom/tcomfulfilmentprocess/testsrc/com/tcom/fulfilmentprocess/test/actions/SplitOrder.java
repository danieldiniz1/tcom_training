 ...
 */
package com.tcom.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TcomFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TcomFulfilmentProcessConstants.PARENT_PROCESS);
