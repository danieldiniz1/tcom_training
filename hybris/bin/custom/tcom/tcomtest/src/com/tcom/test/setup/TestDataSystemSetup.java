...
import com.tcom.test.constants.TcomTestConstants;
import com.tcom.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TcomTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/tcomtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/tcomtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/tcomtest/import/cstickets.impex");
			...
			importImpexFile(context, "/tcomtest/import/csquotes.impex");
		}
	}
}
